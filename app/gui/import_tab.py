...
class ImportTab(QWidget):
    ...
    def __init__(self, config: dict[str, Any], db: Database) -> None:
        ...
        self.rename_after_import_checkbox = QCheckBox("Nach Import im bestehenden Ordner nach aktuellem Dateinamensschema umbenennen")
    ...
    def load_categories(self) -> None:
        ...
        try:
            ...
            for row in self.db.list_categories_full():
                self.category_combo.addItem(str(row["name"]), int(row["id"]))
    ...
    def on_progress(self, progress: object) -> None:
        ...
        self.progress_label.setText(
            ...
            f"Umbenannt: {progress.renamed} | Ohne MD5: {progress.skipped_no_md5} | "
