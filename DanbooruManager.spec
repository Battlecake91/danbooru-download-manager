...
# The previous collect_all("PySide6") pulled in almost every Qt module:
# QML, Quick, WebEngine, Multimedia, 3D, Bluetooth, SQL drivers, Designer, etc.
# For a normal PySide6 Widgets app this is unnecessary and makes the release huge.
hiddenimports = [
    "PySide6.QtCore",
    "PySide6.QtGui",
    "PySide6.QtWidgets",
...
excludes = [
    ...
    # PySide tooling/scripts should never be bundled into the app.
    "PySide6.scripts",
    "PySide6.support",
]
