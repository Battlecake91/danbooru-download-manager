...
> Version `1.3.190` includes the redesigned Importer, Fetch filtering, database-concurrency fixes and the Viewer startup correction.  
...
| [`docs/RELEASE_NOTES_1.3.190.md`](docs/RELEASE_NOTES_1.3.190.md) | Changes included in this release |
