...
> Version `1.3.191` includes the redesigned Importer, Fetch filtering, database-concurrency fixes and the Viewer startup correction.  
...
| [`docs/RELEASE_NOTES_1.3.191.md`](docs/RELEASE_NOTES_1.3.191.md) | Changes included in this release |
