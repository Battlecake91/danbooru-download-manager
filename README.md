...
Release ZIPs are written to `release/` and include the platform and bundle type in the filename, for example `DanbooruManager_1.3.201_win64_portable.zip` or `DanbooruManager_1.3.201_linux_x86_64_onefile.zip`.
...
| [`docs/RELEASE_NOTES_1.3.201.md`](docs/RELEASE_NOTES_1.3.201.md) | Changes included in this release |
